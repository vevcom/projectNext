...
} as const satisfies Record<string, StandardStoreFile>
...
export const standardStoreFiles = {
    ...
    treaty: {
        readFile: standardStoreFile('treaty.jpeg'),
        credit: null,
        license: null,
        originOfFile: pixabayOrigin,
    },
    ...
    defaultProfileImage: {
        readFile: standardStoreFile('default_profile_image.png'),
        credit: null,
        license: null,
        originOfFile: pixabayOrigin,
    },
