...
-- CreateEnum
CREATE TYPE "LedgerAccountType" AS ENUM ('USER', 'GROUP');

-- CreateEnum
CREATE TYPE "LedgerTransactionPurpose" AS ENUM ('SHOP_PURCHASE', 'EVENT_PAYMENT', 'DEPOSIT', 'PAYOUT', 'REFUND');

-- CreateEnum
CREATE TYPE "LedgerTransactionState" AS ENUM ('PENDING', 'FAILED', 'SUCCEEDED', 'CANCELED');

-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('STRIPE', 'MANUAL');

-- CreateEnum
CREATE TYPE "PaymentState" AS ENUM ('PENDING', 'PROCESSING', 'FAILED', 'SUCCEEDED', 'CANCELED');
...
-- CreateTable
CREATE TABLE "GroupLedgerAccount" (
    "id" SERIAL NOT NULL,
    "groupId" INTEGER NOT NULL,
    ...
    CONSTRAINT "GroupLedgerAccount_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "LedgerTransaction" (
    "id" SERIAL NOT NULL,
    "purpose" "LedgerTransactionPurpose" NOT NULL,
    "state" "LedgerTransactionState" NOT NULL,
    "reason" TEXT,
    "description" TEXT,
    "paymentId" INTEGER,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "ManualPayment" (
    ...
    CONSTRAINT "ManualPayment_pkey" PRIMARY KEY ("paymentId")
);
...
CREATE TABLE "StripeCustomer" (
    ...
    CONSTRAINT "StripeCustomer_pkey" PRIMARY KEY ("userId")
);

-- CreateTable
CREATE TABLE "RegisterStudentCardQueue" (
    "userId" INTEGER NOT NULL,
    "expiry" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "RegisterStudentCardQueue_pkey" PRIMARY KEY ("userId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "GroupLedgerAccount_groupId_ledgerAccountId_key" ON "GroupLedgerAccount"("groupId", "ledgerAccountId");
...
-- CreateIndex
CREATE UNIQUE INDEX "LedgerEntry_ledgerTransactionId_ledgerAccountId_key" ON "LedgerEntry"("ledgerTransactionId", "ledgerAccountId");

-- CreateIndex
CREATE UNIQUE INDEX "StripePayment_paymentIntentId_key" ON "StripePayment"("paymentIntentId");

-- CreateIndex
CREATE UNIQUE INDEX "StripePayment_clientSecret_key" ON "StripePayment"("clientSecret");
...
-- AddForeignKey
ALTER TABLE "Dot" ADD CONSTRAINT "Dot_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Dot" ADD CONSTRAINT "Dot_accuserId_fkey" FOREIGN KEY ("accuserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "GroupLedgerAccount" ADD CONSTRAINT "GroupLedgerAccount_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GroupLedgerAccount" ADD CONSTRAINT "GroupLedgerAccount_ledgerAccountId_fkey" FOREIGN KEY ("ledgerAccountId") REFERENCES "LedgerAccount"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "StripePayment" ADD CONSTRAINT "StripePayment_paymentId_fkey" FOREIGN KEY ("paymentId") REFERENCES "Payment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ManualPayment" ADD CONSTRAINT "ManualPayment_paymentId_fkey" FOREIGN KEY ("paymentId") REFERENCES "Payment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RegisterStudentCardQueue" ADD CONSTRAINT "RegisterStudentCardQueue_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
