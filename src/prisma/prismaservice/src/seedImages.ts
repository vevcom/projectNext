import { seedImageConfig, seedSpecialImageConfig, seedLisenceConfig } from './seedImagesConfig'
...
export default async function seedImages(prisma: PrismaClient) {
    // Seed all lisences
    await prisma.lisence.createMany({
        data: seedLisenceConfig
    })
