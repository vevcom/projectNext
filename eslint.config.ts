...
import tsNextRules from 'eslint-config-next/typescript'
...
const eslintConfig = defineConfig([
    {
        files: ['**/*.{ts,tsx}'],
        languageOptions: {
            parser: tsConfigs.parser,
        },
        plugins: {
            '@typescript-eslint': tsConfigs.plugin,
        },
        settings: {
            'import/resolver': {
                typescript: {
        ...
        extends: [
            ...
            tsConfigs.configs.eslintRecommended,
            nextVitals,
            tsNextRules,
        ],
        rules: {
    ...
    globalIgnores([
        ...
        'pncli/**',
        'docs/**',
        'src/prisma/schema/generated/**',
        'src/prisma/owSchema/generated/**',
    ]),
])
